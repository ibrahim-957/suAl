...
public class CreateProductRequest {
    ...
    @Schema(description = "Warehouse ID", required = true)
    @NotNull
    private Long warehouseId;

    @Schema(description = "Product size", required = true)
    @Size(max = 50)
    private String size;

    @Schema(description = "Deposit amount", required = true)
    ...
    @Schema(description = "Buy price", required = true)
    private BigDecimal buyPrice;

    @Schema(description = "Sell price", required = true)
    private BigDecimal sellPrice;

    @Schema(description = "Product description", required = true)
    @Size(max = 2000)
    private String description;

    @Schema(description = "Mineral composition map", required = true)
    private Map<String, String> mineralComposition;

    @Schema(description = "Initial full bottle count", required = true)
    @NotNull
    @Min(value = 0)
    private Integer initialFullCount;

    @Schema(description = "Initial empty bottle count", required = true)
    @NotNull
    @Min(value = 0)
    private Integer initialEmptyCount;

    @Schema(description = "Initial damaged bottle count", required = true)
    @NotNull
    @Min(value = 0)
    private Integer initialDamagedCount;

    @Schema(description = "Minimum stock alert threshold", required = true)
    @Min(value = 1)
