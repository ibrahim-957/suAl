...
public interface ProductMapper {
    ...
    @Mapping(target = "hasDeposit", expression = "java(product.hasDeposit())")
    @Mapping(target = "returnable", source = "returnable")
    @Mapping(target = "hasDepositAndReturnable", expression = "java(product.hasDepositAndReturnable())")
